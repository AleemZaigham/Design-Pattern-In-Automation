...
/**
 * ProductPage containing specific selectors and methods related to product page
 */
export class ProductPage extends BasePage {

  static instance = new ProductPage();
  constructor() {
    super();
    if(ProductPage.instance){
      throw new Error('ProductPage instance already exist. Use ProductPage.getInstance() to access it');
    }
  }
  static getInstance() {
